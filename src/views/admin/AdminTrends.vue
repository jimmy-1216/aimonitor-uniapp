...
.trend-chart { display: flex; align-items: flex-end; gap: 6px; height: 110px; background: #111827; border-radius: 12px; border: 1px solid rgba(99,179,237,0.1); padding: 12px 12px 8px; margin-bottom: 10px; }
...
.data-table { background: #111827; border: 1px solid rgba(99,179,237,0.1); border-radius: 12px; overflow: hidden; margin-bottom: 4px; }
.dt-header { display: grid; grid-template-columns: 2fr 1fr 1fr 1fr; padding: 8px 14px; font-size: 10px; color: #4a5568; letter-spacing: 0.5px; border-bottom: 1px solid rgba(99,179,237,0.08); }
...
.dt-row-alt { background: rgba(255,255,255,0.02); }
.dt-month { font-weight: 600; color: #94a3b8; }

.dist-card { background: #111827; border: 1px solid rgba(99,179,237,0.1); border-radius: 12px; padding: 12px 14px; display: flex; flex-direction: column; gap: 10px; }
.dist-row { display: flex; align-items: center; gap: 8px; }
.dist-dot { width: 7px; height: 7px; border-radius: 50%; flex-shrink: 0; }
.dist-name { font-size: 12px; color: #94a3b8; min-width: 68px; }
.dist-bar-wrap { flex: 1; height: 5px; background: rgba(255,255,255,0.04); border-radius: 3px; overflow: hidden; }
.dist-bar-fill { height: 100%; border-radius: 3px; transition: width 0.6s ease; }
.dist-val { font-size: 12px; color: #4a5568; min-width: 40px; text-align: right; }

.purpose-grid { display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 8px; }
.purpose-cell { background: #111827; border: 1px solid rgba(99,179,237,0.1); border-radius: 10px; padding: 12px 10px; text-align: center; }
...
.purpose-cell-label { font-size: 10px; color: #4a5568; margin-top: 4px; }
</style>
